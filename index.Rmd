...
rammstein_f_l_val <- ggplot(rammstein_first_last, aes(valence, danceability, size=instrumentalness, shape=track.album.release_date, color=tempo))+
  geom_point() 
...
```{r echo=FALSE}
rammstein_dance_val <- ggplot(rammstein, aes(valence, danceability, size=instrumentalness, color=tempo)) +
