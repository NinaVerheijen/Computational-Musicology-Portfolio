...
To see how the albums chagnes over time, the valence, danceability and instrumentalness were plotted for each album. It is clear that the danceability decreases over time, and with that the valence and instrumentalness as well.
...
To get a better understanding of why Spotify gave [*Weit weg*](https://open.spotify.com/track/0sMmtnF7by7WPNeRXCam9H?si=_KUDF8oETGaTsCY6k70F2A) such a high mean tempo, the tempogram of the track is plotted. The left tempogram is the same tempogram as on the right but wrapped into a cyclic tempogram to see more details.
...
### clustering{data-commentary-width=600}
...
heatmaply(
  ...
  layout(autosize = F, width = 800, height = 900)  
```
