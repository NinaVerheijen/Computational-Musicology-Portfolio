...
In conclusion, Rammsteins music definitely changed between their first and latest album. Danceability and valence both decrease over time, both for the studio albums and for the two live albums. On the other hand, the varience in tempo gets higher over time. Their are some atypical tracks in their albums but there is not enough difference between tracks to make distinct clusters.
