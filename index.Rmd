...
Looking at the plot, there is definitely some difference between the two live albums and between the live and studio tracks. One obvious difference is that the live tracks have a higher liveness than the studio track. The live album from Berlin seems to have a higher valence than the live album from Paris, which might be explained by the fact that the older albums also have a higher valence than the newer albums. When comparing the live tracks to their corresponding studio track, almost all studio tracks have a higher valence. When comparing the live tracks to the studio tracks it is clear that the studio tracks have a higher valence and more danceability. The track that changed the least between the live performances is *Sehnsucht*, listen for yourself!
